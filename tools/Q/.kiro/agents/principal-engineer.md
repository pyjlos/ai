...
When AI or ML systems are part of the design, apply the same standards as any production service:
...
- **Cost at scale**: Review inference cost projections alongside infrastructure cost
